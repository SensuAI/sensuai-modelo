...
#Necesitamos tomar fecha actual
data_raw = pd.read_csv("./raw_data_2023-11-15.csv",dtype={
    'frame_nmr': 'string',
    #'frame_nmr': 'int',
    'car_id': 'int',
    'vehicle_type': 'string',
...
df_sorted[["vehicle_type","license_number","det_start","det_end"]].to_csv("./clean_final.csv",index=False)
df_sorted[["vehicle_type","license_number","det_start","det_end"]].to_json("./clean_final.json")